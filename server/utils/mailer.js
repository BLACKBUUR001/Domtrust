        ...
        <div style="padding: 32px 24px;">
          <table style="width: 100%; border-collapse: collapse;">
            <tr>
              ...
              <td style="padding: 12px 0; border-bottom: 1px solid #e9ecef; color: #0a1628; font-weight: 600;">${fname}</td>
            </tr>
            <tr>
              ...
              <td style="padding: 12px 0; border-bottom: 1px solid #e9ecef; color: #0a1628; font-weight: 600;">${lname || '—'}</td>
            </tr>
            <tr>
              ...
              <td style="padding: 12px 0; border-bottom: 1px solid #e9ecef; color: #0a1628; font-weight: 600;"><a href="mailto:${email}" style="color: #e8a020;">${email}</a></td>
            </tr>
            <tr>
              ...
              <td style="padding: 12px 0; border-bottom: 1px solid #e9ecef; color: #0a1628; font-weight: 600;">${phone || '—'}</td>
            </tr>
            <tr>
              ...
              <td style="padding: 12px 0; border-bottom: 1px solid #e9ecef; color: #0a1628; font-weight: 600;">${subject || '—'}</td>
            </tr>
          </table>
          <div style="margin-top: 20px; padding: 16px; background: #fff; border-radius: 8px; border-left: 4px solid #e8a020;">
            ...
            <p style="color: #0a1628; line-height: 1.6; margin: 0; white-space: pre-wrap;">${message || '(Aucun message)'}</p>
          </div>
        </div>
      ...
      <div style="font-family: 'Segoe UI', Arial, sans-serif; max-width: 600px; margin: 0 auto; background: #f8f9fa; border-radius: 12px; overflow: hidden;">
        ...
        <div style="padding: 32px 24px;">
          <div style="background: #fff; border-radius: 8px; padding: 20px; margin-bottom: 16px; border: 1px solid #e9ecef;">
            <h2 style="color: #0a1628; margin: 0 0 4px; font-size: 20px;">${agency_name}</h2>
          ...
          <table style="width: 100%; border-collapse: collapse;">
            <tr>
              ...
              <td style="padding: 12px 0; border-bottom: 1px solid #e9ecef; color: #0a1628; font-weight: 600;">${manager}</td>
            </tr>
            <tr>
              <td style="padding: 12px 0; border-bottom: 1px solid #e9ecef; color: #6c757d; font-size: 13px; text-transform: uppercase; letter-spacing: 1px;">Téléphone</td>
              <td style="padding: 12px 0; border-bottom: 1px solid #e9ecef; color: #0a1628; font-weight: 600;"><a href="tel:${phone}" style="color: #e8a020;">${phone}</a></td>
            </tr>
            <tr>
              ...
              <td style="padding: 12px 0; border-bottom: 1px solid #e9ecef; color: #0a1628; font-weight: 600;">${nb_providers || '—'}</td>
            </tr>
            <tr>
              ...
              <td style="padding: 12px 0; border-bottom: 1px solid #e9ecef; color: #0a1628; font-weight: 600;">${coverage_zone || '—'}</td>
            </tr>
          </table>
        </div>
        <div style="background: #0a1628; padding: 16px 24px; text-align: center;">
